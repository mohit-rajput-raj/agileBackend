...
export const getAllColabration = async (req, res) => {
    try {
        ...
        console.error("error in getAllColabration", { error });
...
export const getColabration = async (req, res) => {
    try {
        ...
        console.error("error in getColabration", { error });
        res.status(500).json({ msg: error.message });
    }
};
export const updateColabration = async (req, res) => {
    try {
        ...
        console.error("error in updateColabration", { error });
        res.status(500).json({ msg: error.message });
    }
};
export const deleteColabration = async (req, res) => {
    try {
        ...
        console.error("error in deleteColabration", { error });
        res.status(500).json({ msg: error.message });
    }
};
